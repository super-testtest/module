...
class Entities
{
    ...
    public function __construct(
        ...
        $this->scope = $scope;
        $this->entities = $this->scope->getValue('oei/export_entities', ScopeConfigInterface::SCOPE_TYPE_DEFAULT);
    }
    ...
    {
        return $this->scope->getValue('oei/import_entities', ScopeConfigInterface::SCOPE_TYPE_DEFAULT);
    }
    ...
    {
        return $this->scope->getValue('oei/import_classes', ScopeConfigInterface::SCOPE_TYPE_DEFAULT);
    }
