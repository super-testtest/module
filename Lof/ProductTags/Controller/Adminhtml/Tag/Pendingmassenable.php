...
class Pendingmassenable extends \Magento\Backend\App\Action {
    ...
    public function execute() {
        ...
        $this->messageManager->addSuccessMessage(__('A total of %1 tag(s) have been approved.', count($itemIds)));
