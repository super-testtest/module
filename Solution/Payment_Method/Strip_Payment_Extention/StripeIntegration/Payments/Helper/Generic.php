...
class Generic
{
    ...
    public function invoiceOrder($order, $transactionId = null, $captureCase = \Magento\Sales\Model\Order\Invoice::CAPTURE_ONLINE, $amount = null, $save = true, $forceInvoice = false)
    {
        if ($save)
        ...
        if ($order->canInvoice() || $forceInvoice)
        {
