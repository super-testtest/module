	       ...
	       //echo "<pre>";print_r($row['customer_email']);
	    	if($row['customer_email']!=''){
	    		...
	    		if($customer_id){
	    			...
	    			$sql1 = "UPDATE `sales_order_grid` SET `customer_id`='".$customer_id."' WHERE increment_id='".$value."'" ;
