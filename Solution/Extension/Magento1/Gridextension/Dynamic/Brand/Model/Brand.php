...
class Dynamic_Brand_Model_Brand extends Mage_Core_Model_Abstract
{
    ...
    {
        parent::_construct();
        $this->_init('dynamic_brand/brand');
    }

	public function validate()
	{
		$errors = array();
		$helper = Mage::helper('dynamic_brand');
		$data = Mage::app()->getRequest()->getParam('brand');
