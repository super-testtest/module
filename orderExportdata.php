<?php
$dataarr= array(100001898,1000000480,100001899,100001900,100001901);

//echo "<pre>";echo count($test);die("fdsgr");
...
$order = $orderInterface->loadByIncrementId($value);
...
foreach ($order->getItems() as $value) {
	...
	$finalData['item'.$j.':product_options'] = 'ser;'.$serializer->serialize($value['product_options']);
